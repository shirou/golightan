...
func NewTerminalFormat() TerminalFormat {
	m := map[highlighter.TokenType]func(string) string{
		...
		highlighter.TokenTypeKeywordConstant:      nil,
		highlighter.TokenTypeKeywordDeclaration:   nil,
		highlighter.TokenTypeKeywordNamespace:     nil,
		...
		highlighter.TokenTypeNameTag:              nil,
		...
		highlighter.TokenTypeStringDouble:         nil,
